...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return <div className="md max-w-[544px] p-4 md:w-1/2">
    <div
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="prose mb-3 max-w-none text-gray-500 dark:text-gray-400">{repository?.description || description}</p>
        ...
        {
          repository ? (<GithubRepo repo={repository} />) : (
            href && <Link
              href={href}
