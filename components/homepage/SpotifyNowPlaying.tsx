...
const SpotifyNowPlaying = () => {
  ...
  return (
    <div className="my-3 flex max-w-[540px] items-center gap-2 rounded-sm bg-gray-200 px-3 py-2 shadow-md dark:bg-[#24283b] dark:shadow-gray-800/40">
      <Spotify className="text-spotify w-6 shrink-0" />
