...
### YouNet Media
<div className="!mt-0 text-sm text-gray-400 italic">Ho Chi Minh City, March 2023 - Now</div>
...
- **Technologies**:
    - Front-end: Javascript, ReactJS, Redux, Redux-Saga, Reactstrap, Bootstrap.
    - Back-end:  FeathersJS, Knex, Objection.js, MySQL, RabbitMQ, Redis, Solr (search engine).


### QKIT Software
<div className="!mt-0 text-sm text-gray-400 italic">Ho Chi Minh City, March 2022 - October 2022 (8 Months)</div>
...
- **Technologies**: 
    - Front-end: TypeScript, NestJS, Postgres, JWT.
    - Back-end: VueJS, Tailwind.
...
- **Technologies**:
    - Front-end: TypeScript, NodeJS, Web Speech API.
    - Back-end: Angular, Tailwindcss.
...
- **Technologies**: ReactJS, Storybook, Strapi.
...
<div className="!m-0 text-sm text-gray-400 italic">From Udemy at February 7, 2023.</div>
- Node.js, Express, MongoDB & More: The Complete Bootcamp 2022. <br />
<div className="!m-0 text-sm text-gray-400 italic">From Udemy at February 20, 2022.</div>
- Language : TOEIC <br />
<div className="!m-0 text-sm text-gray-400 italic">Score: 660/990 at IIG Viet Nam</div>
