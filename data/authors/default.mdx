...
- <Twemoji className="!mr-2" emoji="atom-symbol" /> Upgrading to **React 19**, **Next.js 16**.

- <Twemoji className="!mr-2" emoji="party-popper" /> Adopting **Typescript**, committing with [Conventional
...
- <Twemoji className="!mr-2" emoji="man-technologist" /> My website refers to the design and code from the
  [lehuynh.dev](https://github.com/hta218/leohuynh.dev) repository and incorporates the tailwind-nextjs-starter-blog
